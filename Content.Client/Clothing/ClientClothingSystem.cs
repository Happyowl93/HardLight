        ...
        InventorySlotsComponent? inventorySlots = null)
    {
        ...
        foreach (var (key, layerData) in ev.Layers)
        {
            ...
            if (displacementData is not null)
            {
                ...
                if (!inventory.ForceDisplacements && layerData.State is not null && inventory.SpeciesId is not null && layerData.State.EndsWith(inventory.SpeciesId)) // Starlight edit
                    continue;
