...
public sealed class SurveillanceCameraSpeakerSystem : EntitySystem
{
        ...
        SurveillanceCameraSpeechSendEvent args)
    {
        ...
        _chatSystem.TrySendInGameICMessage(uid, args.Message, InGameICChatType.Speak, ChatTransmitRange.GhostRangeLimit, nameOverride: name, languageOverride: args.Language);
    }
}
