...
namespace Content.Shared.Movement.Systems
{
    public sealed class MovementSpeedModifierSystem : EntitySystem
    {
        ...
        public void ChangeBaseSpeed(EntityUid uid, float baseWalkSpeed, float baseSprintSpeed, float acceleration, MovementSpeedModifierComponent? move = null, float minSpeed = 0.0f, float maxSpeed = 20.0f)
        {
            if (!Resolve(uid, ref move, false))
                return;
            ...
            move.MinSpeedMod = minSpeed;
            move.MaxSpeedMod = maxSpeed;
            Dirty(uid, move);
        }
